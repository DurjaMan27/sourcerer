# Generated by Django 4.2.6 on 2024-01-13 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('results', models.ManyToManyField(to='sourcing.result')),
        ...
        migrations.AddField(
            model_name='user',
            name='savedSearches',
            field=models.ManyToManyField(related_name='searches', to='sourcing.search'),
        ),
        migrations.AddField(
            model_name='user',
